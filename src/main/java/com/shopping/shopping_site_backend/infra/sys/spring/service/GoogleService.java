...
public class GoogleService {
    ...
    private String exchangeCodeForToken(String code) {
        ...
        // 發送 POST 請求
        ResponseEntity<TokenResponse> response = restTemplate.postForEntity(tokenUrl,
                new HttpEntity<>(requestBody, createHeaders()), TokenResponse.class);
    ...
    private GoogleUser fetchUserProfile(String accessToken) {
        ...
        // 發送 GET 請求以獲取用戶資料
        ResponseEntity<GoogleUser> response = restTemplate.exchange(userInfoUrl,
                HttpMethod.GET, new HttpEntity<>(headers), GoogleUser.class);
